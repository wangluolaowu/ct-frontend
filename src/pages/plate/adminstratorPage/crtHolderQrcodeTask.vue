                  ...
                  <el-form-item label="Retcode">
                   ...
                   <el-form-item label="Retmsg">
                    ...
                    <el-input v-model="filters.pi_max_y" placeholder="Dest PosY" style="width:400px"></el-input>
                     ...
                     <el-form-item label="Run Direction"> 
                     <el-select placeholder="Run Direction" v-model="filters.pi_run_direction">
                        <el-option
                            v-for="item in $Enum.EnumSelect().pi_run_direction"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value" 
                        > 
  ...
  methods: {
        submit() {
          ...
          // type: 'warning'
              ...
              axios.post('/adminPageManage/createTask/crtHolderQrcodeTask', qs.stringify(param)).then((res) => {
