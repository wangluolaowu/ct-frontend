  ...
  <div id="mainContainer">
    ...
    <el-table :data="tableData" highlight-current-rowstyle="width: 100%" border v-loading="tableLoading">
               <el-table-column type="index" :label="$t('label.label1_86')" width="150"></el-table-column>
                <el-table-column prop="binTicketNum" :label="$t('label.label2_07')" min-width="200">
                </el-table-column>
                ...
                <el-table-column prop="binkQty" :label="$t('label.label1_80')" min-width="100">
                </el-table-column>
                <el-table-column prop="creationDate" :label="$t('label.label1_72')" min-width="200">
                    ...
                    <el-table-column prop="binGrn" :label="$t('label.label1_99')"  min-width="200">
                    </el-table-column>
                    <el-table-column prop="binWip" :label="$t('label.label1_52')"  min-width="200">
                    </el-table-column>
                    <el-table-column prop="binWipLine" :label="$t('label.label1_54')"  min-width="200">
                    </el-table-column>
                    <el-table-column prop="dealerAccount" :label="$t('label.label1_67')" min-width="200" >
                    </el-table-column>
                    <el-table-column prop="binPartDesc" :label="$t('label.label1_78')"  min-width="200">
                    </el-table-column>
...
export default {
  ...
  methods: { 
    ...
    loadData () {
      ...
      let that = this    
      this.axios.get('/binningManage/binWaveHistory/selectErrorBinWaveHistory', {
        params:this.search
      }).then((res) => {
        // console.log(res);
        if (res.errCode === 'S') {
