        ...
        // 先判断表单是否通过了判断
          this.$refs.addFormData.validate((valid) => {
            ...
            if (valid) {
              ...
              if (param.userId) {
                axios.post('/custom/iFndUsers/updateIFndUsers', qs.stringify(result)).then((res) => {
                  if (res.errCode === 'S') {
                    this.$message({
                      type: 'info',
                      message: '修改成功'
                ...
                axios.post('/custom/iFndUsers/insertIFndUsers', qs.stringify(result)).then((res) => {
                  if (res.errCode === 'S') {
                    this.$message({
                      type: 'info',
                      message: '添加成功'
